<template>
  <PageWrapper title="超限指标相关性分析">
    <a-card>
      ...
      <div class="grid md:grid-cols-2 gap-1" style="margin-top: 10px">
        <div class="border border-gray-400" style="height: 500px; widows: 100%">
          <h2 style="margin-top: 10px; margin-left: 20px"><b>最小支持度设置</b></h2>
          <a-row>
            <a-col :span="3" />
            <a-col :span="16">
              <a-slider
          ...
          <h2 style="margin-top: 10px; margin-left: 20px"><b>最小置信度设置</b></h2>
          <a-row>
            <a-col :span="3" />
            <a-col :span="16">
              <a-slider
          ...
          <h2 style="margin-top: 10px; margin-left: 20px"><b>最小提升度设置</b></h2>
          <a-row>
            <a-col :span="3" />
            <a-col :span="16">
              <a-slider
