...
<script lang="ts">
  ...
  import { getReportQuarter } from '/@/api/report/report';
  ...
  export default {
    ...
    setup() {
      const time = ref<Dayjs>(dayjs().subtract(1, 'quarter').startOf('quarter'));
      ...
      async function getReport() {
        ...
        const data = await getReportQuarter(params);
